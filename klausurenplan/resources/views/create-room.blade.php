    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <form id="create-room-form" class="space-y-4">
            ...
            <div class="flex space-x-4">
                <div class="w-6/12">
                    <label for="name" class="block text-sm font-medium text-gray-700">Raumbezeichnung:</label>
            ...
            <button type="submit" class="mt-2 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-500 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Raum hinzufügen</button>
        </form>
